...
import com.kutman.smanov.sumsartaxi.LocationService;
...
import com.kutman.smanov.sumsartaxi.models.Point;
import com.kutman.smanov.sumsartaxi.models.Request;
import com.kutman.smanov.sumsartaxi.models.Session;
import com.kutman.smanov.sumsartaxi.models.Transport;
import com.kutman.smanov.sumsartaxi.models.TransportList;
...
import com.kutman.smanov.sumsartaxi.session.UserSession;
import com.kutman.smanov.sumsartaxi.utils.Constants;
...
public class MapActivity extends AppCompatActivity implements LocationListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, OnMapReadyCallback, GoogleMap.OnCameraChangeListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(transportSession.isLoggedIn()){
            ...
            Intent locationService = new Intent(MapActivity.this, LocationService.class);
    ...
    protected void onPause() {
        ...
        if(gpsService != null){
            ...
            application.setBackgroundMode(true);
        }
    }
